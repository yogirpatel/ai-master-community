...
When('VR-0020 Click on the create an account', async () => {
	await delay(5000);
	element(by.xpath(".//*[@class='action action-register primary modaltrigger']")).click();
	await delay(10000);
});
...
Then('LP-0090 Download format is displayed', async () => {
	...
	//element(by.xpath("html/body/div[5]/aside[2]/div[2]/header/button/span")).click();
	await delay(5000);
});
...
Then('LLP-0080 Subscription, Parish, Payment information are displayed', async  () => {
    await delay(8000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div/div[1]/div[1]/div/div/div/div[3]/div[2]/modal-link/a/span"))).to.eventually.exist;
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@id='parishCode']"))).to.eventually.exist;
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div/div[1]/div[1]/div/div/div/div[3]/div[2]/subscription-cancel/modal-link/a/span"))).to.eventually.exist;
	await delay(2000);
});
...
Then('close the share icons', async () => {
	element(by.xpath("html/body/div[5]/div/div/topic-share/div[1]/div/div/i")).click(); 
	await delay(10000);
	element(by.xpath("html/body/div[5]/div/div/topic-share/div[1]/div/i")).click(); 
	await delay(10000);
});
